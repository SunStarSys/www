...
<form id="search" action="/dynamic/enquiry{% ifequal path|dirname "/" %}{% else %}{{ path|dirname }}{% endifequal %}/" class="d-flex form-inline right text-light" method="POST">
	...
	<a id="go-to-top" onClick="$('base').remove()" href="#top">Ir al principio</a>&nbsp;<span class="sep"></span>&nbsp;<a href="/about">Acerca de</a>&nbsp;<span class="sep"></span>&nbsp;<a href="/contact">Contacto</a>&nbsp;<span class="sep"></span>&nbsp;<a href="https://x.com/sunstarsys"><i class="fa fa-twitter"></i></a>&nbsp;<span class="sep"></span>&nbsp;<a href="https://www.youtube.com/@joeschaefer6982"><i class="fa fa-youtube"></i></a>&nbsp;<span class="sep"></span>&nbsp;&copy;2026&nbsp;<a href="/"><img src="/images/sunstarlinear.png"></a>&nbsp;Todos&nbsp;derechos&nbsp;reservado.
</footer>
