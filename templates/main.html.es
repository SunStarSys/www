...
<div class="navbar-collapse collapse" id="navbarResponsive">
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">Productos... <span class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
              <li class="dropdown-item{% ifequal path "/orion/index.html"|append:lang %}
                active
                {% endifequal %}"><a class="nav-link text-white" href="/orion/index.html{{ lang }}">Orión&trade; Plataforma wiki #Jamstack</a></li>
