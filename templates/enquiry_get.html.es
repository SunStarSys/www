...
<input type="checkbox" id="confluence" name="confluence" checked /> &nbsp; <label for="confluence">¿Se requiere migración de confianza?</label>

<label>Plan de organización preferido</label>
  <input type="radio" id="planFB" name="plan" value="Free Blog" /> &nbsp; <label for="planFB">Blog gratuito</label>
  <input type="radio" id="planPP" name="plan" value="Professional" checked /> &nbsp; <label for="planPP">Plan profesional</label>
  <input type="radio" id="planBP" name="plan" value="Business" /> &nbsp; <label for="planBP">Plan de negocio</label>
  <input type="radio" id="planEP" name="plan" value="Enterprise" /> &nbsp; <label for="planEP">Plan de empresa</label>
  <input type="radio" id="planSI" name="plan" value="Server" /> &nbsp; <label for="planSI">Instalación del servidor de Orion</label>

<label for="subject">Asunto</label>
  <input name="subject" id="subject" class="form-control" value="Orion " pattern="Orion.*" required />

<input name="demo" id="demo" type="checkbox" /> &nbsp; <label for="demo">Programar una demostración</label>

<input type="hidden" name="lang" value="{{ lang }}" />

<input type="hidden" name="nonce" value="{{ nonce }}" />

<button name="submit" class="btn btn-outline-secondary" value=1 >Enviar</button>
