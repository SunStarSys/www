    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav">
          <li class="nav-item{% if path|starts_with:"/index.md" %}
            active
            {% endif %}"><a class="nav-link text" href="/index.html{{lang}}">Hem</a></li>
          <li class="nav-item{% if path|starts_with:"/about.md" %}
            active
            {% endif %}"><a class="nav-link text" href="/about.html{{lang}}">Om</a></li>
...
<ul class="dropdown-menu me-auto mb-2 mb-lg-0 {% ifequal lang ".he" %}dropdown-menu-left right{% else %}{% ifequal lang ".ar" %}dropdown-menu-left right{% endifequal %}{% endifequal %}" role="menu"
			aria-labelledby="products">
              <li class="dropdown-item"><a class="nav-link text-dark" href="/orion/index.html{{ lang }}">Orion&trade; Wiki-plattformen Jamstack</a></li>
          ...
          <li class="nav-item dropdown">
			...
			aria-labelledby="more">
              <li class="dropdown-item">
                <a class="nav-link text-dark" href="https://github.com/SunStarSys/www">Platskälla</a>
              </li>
              <li class="dropdown-item divider"></li>
              <li class="dropdown-header text-dark">i18n</li>
              <li class="dropdown-item"><a class="nav-link text-dark" href="{{path|dirname|append:"/"}}{{path|basename:0}}.html.en">Engelska</a></li>
              <li class="dropdown-item"><a class="nav-link text-dark" href="{{path|dirname|append:"/"}}{{path|basename:0}}.html.es">Spanska</a></li>
              <li class="dropdown-item"><a class="nav-link text-dark" href="{{path|dirname|append:"/"}}{{path|basename:0}}.html.de">Tyska</a></li>
              <li class="dropdown-item"><a class="nav-link text-dark" href="{{path|dirname|append:"/"}}{{path|basename:0}}.html.fr">Franska</a></li>
              <li class="dropdown-item"><a class="nav-link text-dark" href="{{path|dirname|append:"/"}}{{path|basename:0}}.html.ru">Ryska</a></li>
              <li class="dropdown-item"><a class="nav-link text-dark" href="{{path|dirname|append:"/"}}{{path|basename:0}}.html.zh-TW">kinesiska</a></li>
              <li class="dropdown-item"><a class="nav-link text-dark" href="{{path|dirname|append:"/"}}{{path|basename:0}}.html.ko">Koreanska</a></li>
              <li class="dropdown-item"><a class="nav-link text-dark" href="{{path|dirname|append:"/"}}{{path|basename:0}}.html.ja">Japanska</a></li>
              <li class="dropdown-item"><a class="nav-link text-dark" href="{{path|dirname|append:"/"}}{{path|basename:0}}.html.he">Hebreiska</a></li>
              <li class="dropdown-item"><a class="nav-link text-dark" href="{{path|dirname|append:"/"}}{{path|basename:0}}.html.ar">arabiska</a></li>
              <li class="dropdown-item"><a class="nav-link text-dark" href="{{path|dirname|append:"/"}}{{path|basename:0}}.html.sv">Svenska</a></li>
              <li class="dropdown-item"><a class="nav-link text-dark" href="{{path|dirname|append:"/"}}{{path|basename:0}}.html.pt-BR">Portugisiska</a></li>
              <li class="dropdown-item divider"></li>
    ...
    <form id="search" action="/dynamic/search{% ifequal path|dirname "/" %}{% else %}{{ path|dirname }}{% endifequal %}/" class="d-flex form-inline right text-light" method="GET">
      ...
      <input class="form-control me-2" type="text" name="regex"
        placeholder="PCRE Recursive Search" value="{{ regex }}" />&nbsp;<button type="submit" name="submit" value="1" class="btn btn-outline-danger" style="--bs-btn-color: var(--bs-danger-text-emphasis); border-color: var(--bs-danger-text-emphasis) !important"><i class="fa fa-search"></i></button>
	</form>
  </div>
</header>

<main>
<div id="recent-div" class="position-fixed" style="writing-mode: vertical-rl; top:110px; {% if lang|grep:"[.](he|ar)" %}left:0{% else %}right:0{% endif %}">
...
<div class="container theme-showcase{% ifequal lang ".he" %} rtl{% endifequal %}{% ifequal lang ".ar" %} rtl{% endifequal %}"  id="content">
  ...
  <div class="breadcrumbs">
      {{ breadcrumbs|safe }}&nbsp;&nbsp;<a href="javascript:void(location.href='https://cms.sunstarsys.com/redirect?uri='+escape(location.href))">
        <i class="fa fa-file-pen text-danger-emphasis"></i>
      </a>
  </div>
...
<form id="join" action="/dynamic/enquiry{% ifequal path|dirname "/" %}{% else %}{{ path|dirname }}{% endifequal %}/" class="d-flex form-inline right text-light" method="POST">
      ...
      <input class="form-control me-2" type="email" name="email" required
        placeholder="Join Mailing List" />&nbsp;<button type="submit" name="submit" value="1" class="btn btn-outline-danger" style="--bs-btn-color: var(--bs-danger-text-emphasis); border-color: var(--bs-danger-text-emphasis) !important"><i class="fa fa-envelope-open"></i></button>
</form>

<div id="footer"><a id="go-to-top" onClick="$('base').remove()" href="#top"><i class="fa fa-circle-arrow-up"></i></a>&nbsp;<span class="sep"></span>&nbsp;<a href="/about"><i class="fa fa-circle-info"></i></a>&nbsp;<span class="sep"></span>&nbsp;<a href="/contact"><i class="fa fa-at"></i></a>&nbsp;<span class="sep"></span>&nbsp;<a href="https://x.com/sunstarsys"><i class="fa fa-square-x-twitter"></i></a>&nbsp;<span class="sep"></span>&nbsp;<a href="https://www.youtube.com/@joeschaefer6982"><i class="fa fa-youtube"></i></a>&nbsp;<span class="sep"></span>&nbsp;&copy;2026&nbsp;<a href="/"><img src="/images/sunstarlinear.png"></a>&nbsp;Alla&nbsp;rättigheter&nbsp;reserverad.
</div>
</footer>
