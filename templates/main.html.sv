...
<div class="navbar-collapse collapse" id="navbarResponsive">
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" data-bs-toggle="dropdown">Produkter... <span class="caret"></span></a>
...
<li class="nav-item dropdown">
            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" data-bs-toggle="dropdown">Mer... <span class="caret"></span></a>
            <ul class="dropdown-menu {% ifequal lang ".he" %}dropdown-menu-left right{% else %}{% ifequal lang ".ar" %}dropdown-menu-left right{% endifequal %}{% endifequal %}" role="menu">
			<li class="dropdown-item">
              ...
              <li class="dropdown-item"><a class="nav-link text-white" href="{{path|dirname|append:"/"}}{{path|basename:0}}.html.pt-BR">Portugisiska</a></li>
              ...
              <li class="dropdown-item"><a class="nav-link text-white" href="{{path|dirname|append:"/"}}{{path|basename:0}}.html.ko">Koreanska</a></li>
              <li class="dropdown-item"><a class="nav-link text-white" href="{{path|dirname|append:"/"}}{{path|basename:0}}.html.ja">Japanska</a></li>
              <li class="dropdown-item"><a class="nav-link text-white" href="{{path|dirname|append:"/"}}{{path|basename:0}}.html.ar">arabiska</a></li>
...
<li class="nav-item{% ifequal path "/powered-by.html"|append:lang %} active
            {% endifequal %}"><a class="nav-link" href="/powered-by">Tillhandahålls av...</a>
          </li>
        </ul>
      </div>
