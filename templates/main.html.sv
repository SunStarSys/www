...
<main>
<div id="recent-div" class="position-fixed" style="writing-mode: vertical-rl; top:110px; {% if lang|starts_with:".ar" or lang|starts_with:".he" %}left:0{% else %}right:0{% endif %}">
