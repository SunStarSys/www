...
<h2 class="card-title"><span class="badge bg-success">Новая</span> SunStar Технология CI Linter для систем GitLab {{facts.releases.linter.tag}} теперь доступно в <a href="https://hub.docker.com/r/schaefj/linter/">Docker Hub</a> и <a href={{facts.releases.linter.url}}
>GitHub</a>.</h2>
...
<div class="embed-responsive embed-responsive-16by9">
	 	<iframe allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen class="embed-responsive-item" frameborder="0" src="https://www.youtube.com/embed/H5XhAZtE3Ic" style="max-width:560;max-height:315" title="видео"></iframe>
	</div>
