...
Многие виды должны быть сложены как "фильтры" для предварительной обработки аспектов файла в [`$path`](#) Это новый, как внешний код. [`фрагменты`](#) или [`асимптота`](#)-огороженные блоки разметки. Вы можете увидеть пример этого [здесь](https://github.com/SunStarSys/www.iconoclasts.blog/blob/trunk/lib/view.pm#L53).
