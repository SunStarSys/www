...
<script async="" type="module">
  ...
  const response = await fetch("/dynamic/search.pl/?regex=build%3D;lang={{lang}};as_json=1;markdown_search=1");
  if (response.ok) {
          ...
          options: {
              ...
              onClick: (e, elts, chart) => {
                  if (elts) {
                      ...
                      document.location = "/dynamic/search.pl/?regex=build=" + revision + ";lang={{lang}};markdown_search=1";
                  }
              },
          },
      });
