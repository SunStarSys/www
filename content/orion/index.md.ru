...
{# lede #}<span class="text-white">Корпоративная платформа Wiki</span>&nbsp; для <b>создания, управления и доставки</b> статические веб-страницы с использованием технологии #Jamstack для динамических функций в них{# lede #}.
...
/*-------------------------------------------
	Анимации
-------------------------------------------*/
@-webkit-ключевые рамки FADEY {
  0%   { непрозрачность: 0; }
  100% { непрозрачность: 1; }
}

.theme-showcase {
	-webkit-animation-name: ФАДИ;
	-webkit-animation-duration: 1s;
	-webkit-animation-timing-function: легкость в эксплуатации;
