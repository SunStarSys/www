...
- Att wit: försöker få en fullt fungerande SSI-implementering ur några lokala "webbserver" att du använder för att förhandsgranska dina ändringar i något annat byggsystem, är bara lite dumt om du slutar och tänker på det.  Med vår Orion skapar du bara en gren i svn och av dig går: redigera, begå, bygga, surfa och **iterera**, omedelbart, på en per gren, efemär Apache-serverad webbplats som är integrerad i Orion &trade; IDE:s infrastruktur för dubbelriktad länk (och bokmärkesomdirigering).  <span class="text-success">Utan att någonsin lämna din webbläsare</span>.
