...
<ol>
                        ...
                        <li>$0,10 / sida AI NLP översättningar</li>
</ol>
					</p>
</li>
			</ul>
...
<p>
					<ol>
						...
						<li>$10/säte</li>
						<li>$10/100 byggminuter</li>
                        <li>$0,06 / sida AI NLP översättningar</li>
                    </ol>
					</p>
					</li>
				</ul>
...
- {# lede #}Årliga rabatter på förhandspriser (upp till 20 % rabatt på månadsfaktureringskostnaderna){# lede #}.
