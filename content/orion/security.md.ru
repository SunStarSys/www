...
Часто, если это настроено, отредактированная страница может объявлять свои собственные файлы зависимостей в заголовках страницы, о чем также следует подумать, когда вы взвешиваете наборы функций против элементов безопасности в информационной архитектуре вашей вики.
