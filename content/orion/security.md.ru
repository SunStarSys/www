...
### [RBAC](https://en.wikipedia.org/wiki/Role-based_access_control) модель, перец с [орфрус](https://github.com/SunStarSys/orthrus) [Отп-sha1](https://en.wikipedia.org/wiki/One-time_password) Судовые вызовы. Для входа во все учетные записи инфраструктуры требуется предоставить учетные данные многофакторной аутентификации, включая учетные записи OCI. В этой политике нет бэкдоров, по дизайну.
