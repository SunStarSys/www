...
En consecuencia, la experiencia de edición ocurre en una pila web independiente de imposible acceso sin inicio de sesión válido, es un poco menos rápida una vez que se cargan los cambios, y es mucho menos sucia; porque validamos y construimos el contenido modificado, junto con el corpus de páginas dependientes, *en tiempo de edición, no en tiempo de render*. La creación se lleva a cabo en una zona sandboxed Solaris protegida por separado. Los registros de compilación se publican en la sesión de edición en tiempo real y se guardan en el control de versiones para la posteridad y la responsabilidad empresarial.

En realidad, el costo es unos segundos más de exposición a la maquinaria técnica de la construcción y el proceso de despliegue de archivos estáticos antes de poder ver los cambios confirmados y publicados en el sitio en vivo.
