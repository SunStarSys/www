...
<div class="col-lg-5">
<p>
	<span class="text-success"><img style="width:100px" src="../images/sunstar-orion-symbol-linear.png"><!-- Derived work from Dennis Moskowitz's original CC BySA v4.0 --> &nbsp;<em>Plataforma Wiki #Jamstack.</em></span>&trade;
</p>
...
Lo que realmente distingue a Orión es'Solo otra plataforma wiki:'Nuestra tecnología patentada Orion, un enfoque probado en batalla y pendiente de patente que ofrece una eficiencia inigualable.
...
Orión está construida para líderes que se niegan a settle:
...
¿Quieres transparencia? Consulte yourself:
...
Ver el source: [nuestro árbol lib fuente](https://vcs.sunstarsys.com/repos/svn/public/cms-sites/www.sunstarsys.com/trunk/lib/)o su [<i class="fa fa-github fa-emoji" title="Github"></i> Duplicación GitHub](https://github.com/SunStarSys/www/tree/trunk/lib).

El sitio estático subyacente Generator: open-sourced en GitHub bajo la licencia Apache 2.0 → @SunStarSys/orion

Esto es't marketing spin: es'El patrimonio de ingeniería verificable y abierto se remonta a las innovaciones de F / OSS pioneras en 2011. ¿Listo para experimentar una wiki que realmente ahorra tiempo, dinero y dolores de cabeza? [Llámenos o envíenos una nota](/contact) hoy.
...
<hr />
<br />
<h2>Unos pocos representantes Shots:</h2>
<br />
