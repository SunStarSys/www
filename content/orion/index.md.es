...
<div class="col-lg-5">
<p>
	<span class="text-success"><img src="../images/sunstar-orion-symbol-linear.png" style="width:100px"><!-- Derived work from Dennis Moskowitz's original CC BySA v4.0 --> &nbsp;<em>Wiki Enterprise Jamstack.</em></span>&trade;
</p>
...
- **Líderes universitarios**: elimine el plagio del campus y potencie la colaboración segura y de acceso abierto con uso compartido de documentos controlados por versiones, selección y publicación en línea. Transforme su gestión del conocimiento académico en una plataforma moderna y auditable.

**Gobierno &amp; responsables de la toma de decisiones de TI de defensa** — Cumpla con la infraestructura FedRAMP, los requisitos de confianza cero del NIST 800-207 y los controles de acceso detallados en su repositorio de control de versiones, todo ello con seguridad compatible con FIPS 140-3 e instalable dentro de su VPN corporativa.
...
Sin dependencia de proveedores, y demostramos que el contenido de it.Your reside en un Markdown limpio y en flujos de trabajo estándar de control de versiones. Sin formatos propios. Sin pesadillas migratorias.
...
Ver el código fuente: [nuestro árbol de lib fuente viewvc](https://vcs.sunstarsys.com/viewvc/public/cms-sites/www.sunstarsys.com/trunk/lib/)o su [<i class="fa fa-github fa-emoji" title="Github"></i> Duplicado GitHub](https://github.com/SunStarSys/www/tree/trunk/lib).

El generador de sitios estáticos subyacente: de código abierto en GitHub bajo la licencia Apache 2.0 → <https://github.com/SunStarSys/Orion>.
...
Esta tecnología fue inventada por primera vez a finales de 2011 por los miembros del equipo de infraestructura de Apache. La frase "[Pila JAM](https://jamstack.wtf)"fue acuñado años después, por un grupo que desconoce nuestro arte anterior en este espacio.  Pero el [registro público](http://web.archive.org/web/20120112045033/http://www.apache.org/dev/Orion) Esta nueva oferta de SunStar Systems es testimonio de ese legado original y sus verdaderos orígenes de código abierto.
...
<br />
<h3><a href="https://cms.sunstarsys.com/redirect?uri=https://www.sunstarsys.com/;action=search;regex=mailto:">IDE Search</a> <small>(aquellos enlaces en <span style="color:#e83e8c">rosa caliente</span> le colocarán directamente en una pantalla del editor, con el cursor colocado exactamente según el texto coincidente)</small>.</h3>
