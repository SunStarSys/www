...
<div class="col-lg-5">
<p>
	<span class="text-success"><img src="../images/sunstar-orion-symbol-linear.png" style="width:100px"><!-- Derived work from Dennis Moskowitz's original CC BySA v4.0 --> &nbsp;<em>Wiki de Enterprise Jamstack.</em></span>&trade;
</p>
<span class="text-white">SunStar Orión de sistemas</span> &nbsp; es un
<p>
	<ul>
	<li><p>seguro,</p></li>
	<li><p>amigable con el móvil,</p></li>
	<li><p>colaborativa,</p></li>
	<li><p>rendimiento máximo,</p></li>
	<li><p>federado</p></li>
	</ul>
</p>
{# lede #}<span class="text-white">Wiki de empresa</span>&nbsp; para <b>crear, gestionar y entregar</b> páginas web estáticas mediante la tecnología #Jamstack para las funciones dinámicas que contiene{# lede #}

Para obtener información sobre precios, consulte nuestra [Planes Orion](plans).
...
[nuestro viewvc fuente lib tree](https://vcs.sunstarsys.com/viewvc/public/cms-sites/www.sunstarsys.com/trunk/lib/), o su [<i class="fa fa-github fa-emoji" title="Github"></i> Duplicación GitHub](https://github.com/SunStarSys/www/tree/trunk/lib).

Menos de <span class="text-info">100 LOC</span> para proporcionar la lógica de creación de este sitio web e incluye una gestión de dependencias sofisticada y memorizada para la generación automática de un sitio multilingüe [SiteMap](/sitemap) y todos los índices de directorio (como [esta parte](#Details) de esta página en particular).  Incluso ponemos la base [Generador de sitio estático para la compilación en GitHub](https://github.com/SunStarSys/Orion).
...
Si está cansado de las opciones de licencia por asiento y por ciclo de CPU que le pesan cada vez que necesita corregir un error tipográfico, [llegar a nosotros](/contact).
...
Los árboles de origen de varios gigabytes simplemente no coinciden &mdash; Las duraciones de creación del sitio completo se miden en *segundos*, no en horas y minutos.  El sistema se mantiene fácilmente [`500 MB/s`](features).

<span class="text-success"><em>Solo construimos lo que necesitas construir.</span></em>&trade;

Esta tecnología fue inventada por primera vez a finales de 2011 por miembros del equipo de infraestructura Apache. La frase "[Pila de JAM](https://jamstack.wtf)Fue acuñado años después por un grupo que desconocía nuestro arte anterior en este espacio.  Pero el [registro público](http://web.archive.org/web/20120112045033/http://www.apache.org/dev/Orion).

<h4>¿Quieres darle un giro rápido para ver lo rápido y fácil que es?</h4>

Este sitio web es autoalojado; todos esos cuadrados de lápiz rosa caliente [<img src="../images/edit.png" style="width:20px">](https://cms.sunstarsys.com/redirect?uri=https://www.sunstarsys.com/index).

Nuestra red global de punto de presencia (POP) garantiza conexiones de baja latencia a ambos Orion &trade;
...
| Función     |   Orion       | Tramo | Noción | Confluencia |
|:^-----------|:-------------:|:----:|:------:|:----------:|
...
<br />
<h3>Creación de sitio completo de IDE.</h3>
...
<br />
<h3><a href="https://cms.sunstarsys.com/redirect?uri=https://www.sunstarsys.com/;action=search;regex=mailto:">IDE Search</a> <small>(esos enlaces en <span style="color:#e83e8c">hot pink</span> le colocarán directamente en la pantalla del editor, con el cursor colocado exactamente según el texto coincidente)</small>.</h3>
