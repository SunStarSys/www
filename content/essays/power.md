...
(ie all `derivatives`) would all have the same multiplier (over those same intervals).
...
increases 10-fold, just as indicated by the parallel lines in the following graphs.
