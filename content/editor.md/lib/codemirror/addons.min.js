...
CodeMirror.runMode = function(string, modespec, callback, options) {
  ...
  if (callback.nodeType == 1) {
    ...
    var node = callback, col = 0, lineno = 0;
      node.innerHTML = (options && options.lineNumbers) ? "<style type='text/css'> span.line-numbers {background: #eee; color: #888; padding: 4px 8px; text-align: right' user-select: none}</style>" : "";
