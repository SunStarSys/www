...
(function(mod) {
  ...
  "use strict";
    ...
    var keywords = ["block", "endblock", "for", "endfor", "true", "false", "filter", "endfilter",
        ...
        filters = ["add", "addslashes", "capfirst", "center", "cut", "date",
                   ...
                   "urlize", "trunc", "wordcount", "wordwrap", "yesno", "markdown", "vcs_author", "vcs_date", "vcs_time", "vcs_revision", "append", "basename", "cuts", "starts_with", "dirname", "md2tex", "tex2md", "lede", "ssi", "split", "shuffle", "img", "strip_prefix", "parse_filename", "selectattr"],
        operators = ["==", "!=", "<", ">", "<=", ">="],
  ...
  CodeMirror.defineMode("html+django", function(config) {
    ...
    var djangoInner = CodeMirror.getMode(config, "django:inner");
      return CodeMirror.overlayMode(htmlBase, djangoInner, false);
  });

  CodeMirror.defineMIME("text/x-html+django", "html+django");

  CodeMirror.defineMode("yaml+django", function(config) {
    var djangoInner = CodeMirror.getMode(config, "django:inner");
    var yamlInner = CodeMirror.getMode(config, "yaml");
      return CodeMirror.overlayMode(yamlInner,djangoInner,false);
  });
    
  CodeMirror.defineMIME("text/x-yaml+django", "yaml+django");
...
(function(mod) {
  ...
  CodeMirror.defineMode("gfm+django+stex", function(config) {
    ...
    var stexInner = CodeMirror.getMode(config, "stex");
      return CodeMirror.overlayMode(CodeMirror.overlayMode(gfmBase,stexInner,true),djangoInner,false);
  });

  CodeMirror.defineMIME("text/x-gfm+django+stex", "gfm+django+stex");

  CodeMirror.defineMode("stex+django", function(config) {
    var djangoInner = CodeMirror.getMode(config, "django:inner");
    var stexInner = CodeMirror.getMode(config, "stex");
      return CodeMirror.overlayMode(stexInner,djangoInner,false);
  });

  CodeMirror.defineMIME("text/x-stex+django", "stex+django");
