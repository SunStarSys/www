  ...
  "use strict";
    ...
    var keywords = ["block", "endblock", "for", "endfor", "true", "false", "filter", "endfilter",
        ...
        filters = ["add", "addslashes", "capfirst", "center", "cut", "date",
                   ...
                   "urlize", "trunc", "wordcount", "wordwrap", "yesno", "markdown", "vcs_author", "vcs_date", "vcs_time", "vcs_revision", "append", "basename", "dirname", "lede", "ssi", "strip_prefix", "parse_filename"],
        operators = ["==", "!=", "<", ">", "<=", ">="],
...
(function(mod) {
  ...
  CodeMirror.defineMode("gfm+django", function(config) {
    ...
    return CodeMirror.overlayMode(gfmBase,CodeMirror.overlayMode(djangoInner,stexInner));
  });
