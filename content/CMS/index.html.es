...
Actualmente proporcionamos un sistema de plantilla básico basado en <span class="text-white">Django</span> derivado de un [`Dotiac::DTL`](http://dotiac.sourceforge.net/cgi-bin/) personalizado index.pl) módulo de CPAN. Próximamente se brindará soporte para un sistema de compilación de Python 3. El [sistema de compilación CMS](https://github.com/SunStarSys/cms), junto con una gran colección de módulos de soporte para aprovechar dentro de ese árbol, está disponible en GitHub.
