...
- Subversion supports **fine-grained access control**, and lets you do partial/sparse checkouts of `HEAD`; with Git you have NO ACLs other than on a server push, and you must clone the entire branch (which includes history) or nothing.  If you don't recognize the necessity of these feature sets, you haven't groked the previous item's (see above) remarks quite yet.
