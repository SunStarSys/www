...
- LIMITED TIME OFFER: <span class="text-success">$200 / month / managed site</span> (90% discount over WordPress/Netlify Enterprise).  First month is <span class="text-success">FREE</span>.
	...
	- Unlike our competition, there are no add-on fees for CPU cycles required for your builds, and no-per-seat licensing fees if you provide your own subversion server to manage your sources.
